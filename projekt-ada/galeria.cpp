...
void Eksponat::wczytajDaneEksponatuZPliku(ifstream& f) {
	;
}

void Eksponat::zapiszDoPliku(ofstream& f) const {
	f << id << endl;
	f << imie_autora << endl;
...
void Eksponat::wczytajZPliku(ifstream& f) {
